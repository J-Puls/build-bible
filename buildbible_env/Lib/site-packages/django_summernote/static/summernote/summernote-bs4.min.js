...
! function (t, e) {
    ...
    var i = function () {
        ...
        o = function (o, n) {
            return function () {
                var t = "object" == typeof arguments[1] ? arguments[1] : arguments[0],
                    e = C.isArray(arguments[0]) ? arguments[0] : [];
        ...
        u = o('<div class="dropdown-menu" role="list">', function (t, i) {
            var e = C.isArray(i.items) ? i.items.map(function (t) {
        ...
        h = o('<div class="dropdown-menu note-check" role="list">', function (t, n) {
            var e = C.isArray(n.items) ? n.items.map(function (t) {
                var e = "string" == typeof t ? t : t.value || "",
    ...
    if (!T && y)
        if ("function" == typeof __webpack_require__) try {
            require.resolve("codemirror"), T = !0
        } catch (t) {} else if ("undefined" != typeof require)
            if (void 0 !== require.resolve) try {
                require.resolve("codemirror"), T = !0
            } catch (t) {} else void 0 !== require.specified && (T = require.specified("codemirror"));
    var N = "ontouchstart" in window || 0 < navigator.MaxTouchPoints || 0 < navigator.msMaxTouchPoints,
    ...
    var z = {
            ...
            unique: function (t) {
                for (var e = [], o = 0, n = t.length; o < n; o++) B(e, t[o]) || e.push(t[o]);
                return e
            }
        },
    ...
    var et = U("A");
    var ot = U("BODY");
    var nt = R.isMSIE && R.browserVersion < 11 ? "&nbsp;" : "<br>";
    ...
    function rt(t) {
        var e = it(t);
        return 0 === e || (!j(t) && 1 === e && t.innerHTML === nt || !(!z.all(t.childNodes, j) || "" !== t.innerHTML))
    }
    ...
    function wt(t, e) {
        ...
        return ut(s, ct(r)), o || (st(t.node), st(s)), i && (rt(t.node) && It(t.node), rt(s)) ? (It(s), t.node.nextSibling) : s
    }

    function xt(t, o, n) {
        var e = lt(o.node, A.eq(t));
    ...
    var Nt = {
            ...
            makeOffsetPath: function (t, e) {
                return lt(e, A.eq(t)).map(vt).reverse()
            },
            ...
            replace: function (t, e) {
                ...
                var o = St(e);
                return t.style.cssText && (o.style.cssText = t.style.cssText), ut(o, z.from(t.childNodes)), dt(o, t), It(t), o
            },
            html: function (t, e) {
                var o = $t(t);
            ...
            isCustomStyleTag: function (t) {
                return t && !j(t) && z.contains(t.classList, "note-styletag")
            }
        },
        Et = function () {
            function t(t, e) {
            ...
            return t.prototype.initialize = function () {
                ...
                var t = z.head(arguments),
                    e = z.tail(z.from(arguments)),
                ...
                e.shouldInitialize = e.shouldInitialize || A.ok, e.shouldInitialize() && (e.initialize && e.initialize(), e.events && Nt.attachEvents(this.$note, e.events))
    ...
    function Lt(t) {
        var s = function (t, e) {
                var o, n;
                if (Nt.isText(t)) {
                    var i = Nt.listPrev(t, A.not(Nt.isText)),
                        r = z.last(i).previousSibling;
                    o = r || t.parentNode, e += z.sum(z.tail(i), Nt.nodeLength), n = !r
                } else {
    ...
    C.fn.extend({
        summernote: function () {
            var t = C.type(z.head(arguments)),
                e = "string" === t,
                o = "object" === t,
                i = C.extend({}, C.summernote.options, o ? z.head(arguments) : {});
            ...
            if (n.length) {
                ...
                if (e) return r.invoke.apply(r, z.from(arguments));
    ...
    var At = function () {
            ...
            return r.prototype.nativeRange = function () {
                ...
                return e.setEndPoint("EndToEnd", Lt({
                    node: this.ec,
                    offset: this.eo
                })), e
                ...
                return Nt.walkPoint(e, r, function (t) {
                    var e;
                    Nt.isEditable(t.node) || (i ? (Nt.isLeftEdgePoint(t) && a.push(t.node), Nt.isRightEdgePoint(t) && z.contains(a, t.node) && (e = t.node)) : e = n ? Nt.ancestor(t.node, o) : t.node, e && o(e) && s.push(e))
                }, !0), z.unique(s)
                ...
                if (Nt.isInline(e.sc)) {
                    var o = Nt.listAncestor(e.sc, A.not(Nt.isInline));
                    t = z.last(o), Nt.isInline(t) || (t = o[o.length - 2] || e.sc.childNodes[e.so])
                ...
                if ((n = n.concat(Nt.listNext(t.nextSibling, Nt.isParaInline))).length) {
                    var i = Nt.wrap(z.head(n), "p");
                    Nt.appendChildNodes(i, z.tail(n))
                }
                ...
                return {
                    s: {
                        path: z.tail(Nt.makeOffsetPath(z.head(t), this.sc)),
                        offset: this.so
                    },
                    e: {
                        path: z.tail(Nt.makeOffsetPath(z.last(t), this.ec)),
                        offset: this.eo
                    }
                }
        ...
        Ft = {
            create: function (t, e, o, n) {
                if (4 === arguments.length) return new At(t, e, o, n);
                if (2 === arguments.length) return new At(o = t, n = e, o, n);
            ...
            createFromBookmark: function (t, e) {
                var o = Nt.fromOffsetPath(t, e.s.path),
                    ...
                    r = e.e.offset;
                return new At(o, n, i, r)
            },
            createFromParaBookmark: function (t, e) {
                var o = t.s.offset,
                    n = t.e.offset,
                    i = Nt.fromOffsetPath(z.head(e), t.s.path),
                    r = Nt.fromOffsetPath(z.last(e), t.e.path);
                return new At(i, o, r, n)
            }
        },
        Pt = {
            BACKSPACE: 8,
        ...
        Ht = {
            isEdit: function (t) {
                return z.contains([Pt.BACKSPACE, Pt.TAB, Pt.ENTER, Pt.SPACE, Pt.DELETE], t)
            },
            isMove: function (t) {
                return z.contains([Pt.LEFT, Pt.UP, Pt.RIGHT, Pt.DOWN], t)
            },
            nameFromCode: A.invertObject(Pt),
            code: Pt
        };
    var Dt = function () {
            function t(t) {
        ...
        Bt = function () {
            ...
            return t.prototype.jQueryCSS = function (o, t) {
                ...
                var e = C(Nt.isElement(t.sc) ? t.sc : t.sc.parentNode),
                    o = this.fromNode(e);
                try {
                    o = C.extend(o, {
                ...
                if (t.isOnList()) {
                    var n = -1 < C.inArray(o["list-style-type"], ["circle", "disc", "disc-leading-zero", "square"]);
        ...
        zt = function () {
            ...
            return t.prototype.insertOrderedList = function (t) {
                ...
                var i = this,
                    ...
                    n = z.clusterBy(o, A.peq2("parentNode"));
                ...
                var n = this,
                    ...
                    i = z.clusterBy(o, A.peq2("parentNode"));
                C.each(i, function (t, e) {
                    var o = z.head(e);
                    Nt.isLi(o) ? n.releaseList([e]) : C.each(e, function (t, e) {
                        C(e).css("marginLeft", function (t, e) {
                ...
                var n = this,
                    ...
                    r = e.paraBookmark(i),
                    s = z.clusterBy(i, A.peq2("parentNode"));
                if (z.find(i, Nt.isPurePara)) {
                    var a = [];
                ...
                }), Nt.appendChildNodes(s, t), r && (Nt.appendChildNodes(s, z.from(r.childNodes)), Nt.remove(r)), t
                ...
                return C.each(t, function (t, e) {
                    ...
                    if ("LI" === i.parentNode.nodeName) e.map(function (t) {
                        ...
                        e = c ? Nt.listDescendant(a, Nt.isLi) : z.from(a.childNodes).filter(Nt.isLi), !c && Nt.isList(i.parentNode) || (e = e.map(function (t) {
                            return Nt.replace(t, "P")
                        })), C.each(z.from(e).reverse(), function (t, e) {
                            Nt.insertAfter(e, i)
                        });
                        var l = z.compact([i, a, s]);
                ...
                return t ? z.find(t.children, function (t) {
        ...
        Mt = function () {
            function t(t) {
                this.bullet = new zt, this.options = t.options
            }
            return t.prototype.insertTab = function (t, e) {
                ...
                if (n) {
                    ...
                    if (1 === this.options.blockquoteBreakingLevel ? i = Nt.ancestor(n, Nt.isBlockquote) : 2 === this.options.blockquoteBreakingLevel && (i = Nt.lastAncestor(n, Nt.isBlockquote)), i) {
                        o = C(Nt.emptyPara)[0], Nt.isRightEdgePoint(e.getStartPoint()) && Nt.isBR(e.sc.nextSibling) && C(e.sc.nextSibling).remove();
                        ...
                        s = s.concat(Nt.listDescendant(o, Nt.isEmptyAnchor)), C.each(s, function (t, e) {
                            Nt.remove(e)
                        }), (Nt.isHeading(o) || Nt.isPre(o) || Nt.isCustomStyleTag(o)) && Nt.isEmpty(o) && (o = Nt.replace(o, "p"))
                    }
                } else {
                    var a = e.sc.childNodes[e.so];
                    o = C(Nt.emptyPara)[0], a ? e.sc.insertBefore(o, a) : e.sc.appendChild(o)
                }
        ...
        Ot = function (t, h, p, i) {
            ...
            function k(t) {
                switch (h) {
                    case Ot.where.Column:
                        if (t.isColSpan) return Ot.resultAction.SubtractSpanCount;
                        break;
                    case Ot.where.Row:
                        if (!t.isVirtual && t.isRowSpan) return Ot.resultAction.AddCell;
                        if (t.isRowSpan) return Ot.resultAction.SubtractSpanCount
                }
                return Ot.resultAction.RemoveCell
            }

            function C(t) {
                switch (h) {
                    case Ot.where.Column:
                        if (t.isColSpan) return Ot.resultAction.SumSpanCount;
                        if (t.isRowSpan && t.isVirtual) return Ot.resultAction.Ignore;
                        break;
                    case Ot.where.Row:
                        if (t.isRowSpan) return Ot.resultAction.SumSpanCount;
                        if (t.isColSpan && t.isVirtual) return Ot.resultAction.Ignore
                }
                return Ot.resultAction.AddCell
            }
            this.getActionList = function () {
                    for (var t, e, o, n = h === Ot.where.Row ? f.rowPos : -1, i = h === Ot.where.Column ? f.colPos : -1, r = 0, s = !0; s;) {
                        var a = 0 <= n ? n : r,
                            l = 0 <= i ? i : r,
                            c = m[a];
                        if (!c) return s = !1, g;
                        var d = c[l];
                        if (!d) return s = !1, g;
                        var u = Ot.resultAction.Ignore;
                        switch (p) {
                            case Ot.requestAction.Add:
                                u = C(d);
                                break;
                            case Ot.requestAction.Delete:
                                u = k(d)
                        }
                        g.push((t = u, e = a, o = l, {
                            baseCell: d.baseCell,
    ...
    var Ut, jt = function () {
            ...
            return t.prototype.tab = function (t, e) {
                ...
                for (var o = Nt.ancestor(t.commonAncestor(), Nt.isCell), n = C(o).closest("tr"), i = this.recoverAttributes(n), r = C("<tr" + i + "></tr>"), s = new Ot(o, Ot.where.Row, Ot.requestAction.Add, C(n).closest("table")[0]).getActionList(), a = 0; a < s.length; a++) {
                    var l = s[a],
                        ...
                        case Ot.resultAction.SumSpanCount:
                            if ("top" === e)
                                if ((l.baseCell.parent ? l.baseCell.closest("tr").rowIndex : 0) <= n[0].rowIndex) {
                                    var d = C("<div></div>").append(C("<td" + c + ">" + Nt.blank + "</td>").removeAttr("rowspan")).html();
                                    r.append(d);
                                    break
                ...
                var o = Nt.ancestor(t.commonAncestor(), Nt.isCell),
                    n = C(o).closest("tr");
                C(n).siblings().push(n);
                for (var i = new Ot(o, Ot.where.Column, Ot.requestAction.Add, C(n).closest("table")[0]).getActionList(), r = 0; r < i.length; r++) {
                    var s = i[r],
                        a = this.recoverAttributes(s.baseCell);
                    switch (s.action) {
                        case Ot.resultAction.AddCell:
                            "right" === e ? C(s.baseCell).after("<td" + a + ">" + Nt.blank + "</td>") : C(s.baseCell).before("<td" + a + ">" + Nt.blank + "</td>");
                            break;
                        case Ot.resultAction.SumSpanCount:
                            if ("right" === e) {
                                var l = parseInt(s.baseCell.colSpan, 10);
                                l++, s.baseCell.setAttribute("colSpan", l)
                            } else C(s.baseCell).before("<td" + a + ">" + Nt.blank + "</td>")
                    }
                }
                ...
                for (var e = Nt.ancestor(t.commonAncestor(), Nt.isCell), o = C(e).closest("tr"), n = o.children("td, th").index(C(e)), i = o[0].rowIndex, r = new Ot(e, Ot.where.Row, Ot.requestAction.Delete, C(o).closest("table")[0]).getActionList(), s = 0; s < r.length; s++)
                    if (r[s]) {
                        var a = r[s].baseCell,
                            l = r[s].virtualTable,
                ...
                for (var e = Nt.ancestor(t.commonAncestor(), Nt.isCell), o = C(e).closest("tr"), n = o.children("td, th").index(C(e)), i = new Ot(e, Ot.where.Column, Ot.requestAction.Delete, C(o).closest("table")[0]).getActionList(), r = 0; r < i.length; r++)
        ...
        qt = function () {
            function t(t) {
                ...
                this.insertParagraph = this.wrapCommand(function () {
                    ...
                    u.isLimited(C(t).text().length) || (u.getLastRange().insertNode(t), Ft.createFromNodeAfter(t).select(), u.setLastRange())
                }), this.insertText = this.wrapCommand(function (t) {
                    if (!u.isLimited(t.length)) {
                        var e = u.getLastRange().insertNode(Nt.createText(t));
                        Ft.create(e, Nt.nodeLength(e)).select(), u.setLastRange()
                    }
                }), this.pasteHTML = this.wrapCommand(function (t) {
                    if (!u.isLimited(t.length)) {
                        t = u.context.invoke("codeview.purify", t);
                        var e = u.getLastRange().pasteHTML(t);
                        Ft.createFromNodeAfter(z.last(e)).select(), u.setLastRange()
                    }
                    ...
                    var t = u.getLastRange().insertNode(Nt.create("HR"));
                    t.nextSibling && (Ft.create(t.nextSibling, 0).normalize().select(), u.setLastRange())
                    ...
                    if (!(0 < r && u.isLimited(r))) {
                        ...
                        var c = Ft.createFromNodeBefore(z.head(a)).getStartPoint(),
                            d = Ft.createFromNodeAfter(z.last(a)).getEndPoint();
                        Ft.create(c.node, c.offset, d.node, d.offset).select(), u.setLastRange()
                    }
            ...
            return t.prototype.initialize = function () {
                ...
                this.$editable.on("keydown", function (t) {
                    if (t.keyCode === Ht.code.ENTER && e.context.triggerEvent("enter", t), e.context.triggerEvent("keydown", t), t.isDefaultPrevented() || (e.options.shortcuts ? e.handleKeyMap(t) : e.preventDefaultEditableShortCuts(t)), e.isLimited(1, t)) return !1
                }).on("keyup", function (t) {
                ...
                }), this.$editable.attr("spellcheck", this.options.spellCheck), this.$editable.html(Nt.html(this.$note) || Nt.emptyPara), this.$editable.on(R.inputEventName, A.debounce(function () {
                ...
                var n = Ht.nameFromCode[t.keyCode];
                n && o.push(n);
                var i = e[o.join("+")];
                i ? !1 !== this.context.invoke(i) && t.preventDefault() : Ht.isEdit(t.keyCode) && this.afterCommand()
            }, t.prototype.preventDefaultEditableShortCuts = function (t) {
                (t.ctrlKey || t.metaKey) && z.contains([66, 73, 85], t.keyCode) && t.preventDefault()
            }, t.prototype.isLimited = function (t, e) {
                return t = t || 0, (void 0 === e || !(Ht.isMove(e.keyCode) || e.ctrlKey || e.metaKey || z.contains([Ht.code.BACKSPACE, Ht.code.DELETE], e.keyCode))) && (0 < this.options.maxTextLength && this.$editable.text().length + t >= this.options.maxTextLength)
            }, t.prototype.createRange = function () {
                return this.focus(), this.setLastRange(), this.getLastRange()
            }, t.prototype.setLastRange = function () {
                this.lastRange = Ft.create(this.editable)
                ...
                return (o = t, C.Deferred(function (t) {
                    ...
                    n.beforeCommand(), "function" == typeof e ? e(t) : ("string" == typeof e && t.attr("data-filename", e), t.css("width", Math.min(n.$editable.width(), t.width()))), t.show(), Ft.create(n.editable).insertNode(t[0]), Ft.createFromNodeAfter(t[0]).select(), n.setLastRange(), n.afterCommand()
                }).fail(function (t) {
                ...
                if (o) {
                    ...
                    if (C(n).css(t, e), o.isCollapsed()) {
                        var i = z.head(n);
                        i && !Nt.nodeLength(i) && (i.innerHTML = Nt.ZERO_WIDTH_NBSP_CHAR, Ft.createFromNodeAfter(i.firstChild).select(), this.setLastRange(), this.$editable.data("bogus", i))
                    }
                }
                ...
                if (t.isOnAnchor()) {
                    ...
                    (t = Ft.createFromNode(e)).select(), this.setLastRange(), this.beforeCommand(), document.execCommand("unlink"), this.afterCommand()
                }
            }, t.prototype.getLinkInfo = function () {
                var t = this.getLastRange().expand(Nt.isAnchor),
                    e = C(z.head(t.nodes(Nt.isAnchor))),
                    o = {
                        range: t,
                        text: t.toString(),
        ...
        Kt = function () {
            ...
            return t.prototype.initialize = function () {
                ...
                if (e && e.items && e.items.length) {
                    var o = 1 < e.items.length ? e.items[1] : z.head(e.items);
    ...
    R.hasCodeMirror && (R.isSupportAmd ? require(["codemirror"], function (t) {
        Ut = t
    ...
    var Vt = function () {
            ...
            return t.prototype.sync = function () {
                ...
                if (this.options.codeviewFilter && (t = t.replace(this.options.codeviewFilterRegex, ""), this.options.codeviewIframeFilter)) {
                    ...
                    t = t.replace(/(<iframe.*?>.*?(?:<\/iframe>)?)/gi, function (t) {
                        ...
                        for (var e = 0, o = i; e < o.length; e++) {
                            var n = o[e];
                            if (new RegExp('src="(https?:)?//' + n + '/(.+)"').test(t)) return t
                        }
                        return ""
                    })
                }
                ...
                var e = this;
                if (this.$codable.val(Nt.html(this.$editable, this.options.prettifyHtml)), this.$codable.height(this.$editable.height()), this.context.invoke("toolbar.updateCodeview", !0), this.$editor.addClass("codeview"), this.$codable.focus(), R.hasCodeMirror) {
                    var o = Ut.fromTextArea(this.$codable[0], this.options.codemirror);
                    if (this.options.codemirror.tern) {
                        var n = new Ut.TernServer(this.options.codemirror.tern);
                ...
                var e = this.purify(Nt.value(this.$codable, this.options.prettifyHtml) || Nt.emptyPara),
        ...
        Yt = /^([A-Za-z][A-Za-z0-9+-.]*\:[\/]{2}|mailto:[A-Z0-9._%+-]+@)?(www\.)?(.+)$/i,
        Qt = function () {
            function t(t) {
                var o = this;
            ...
            return t.prototype.initialize = function () {
                ...
                if (z.contains([Ht.code.ENTER, Ht.code.SPACE], t.keyCode)) {
                    var e = this.context.invoke("editor.createRange").getWordRange();
                    this.lastWordRange = e
                }
            }, t.prototype.handleKeyup = function (t) {
                z.contains([Ht.code.ENTER, Ht.code.SPACE], t.keyCode) && this.replace()
            }, t
        }(),
        Jt = function () {
            function t(t) {
        ...
        Xt = function () {
            function t(t) {
                var o = this;
                this.context = t, this.options = t.options.replace || {}, this.keys = [Ht.code.ENTER, Ht.code.SPACE, Ht.code.PERIOD, Ht.code.COMMA, Ht.code.SEMICOLON, Ht.code.SLASH], this.previousKeydownCode = null, this.events = {
                    "summernote.keyup": function (t, e) {
                        e.isDefaultPrevented() || o.handleKeyup(e)
                    },
                    "summernote.keydown": function (t, e) {
            ...
            return t.prototype.shouldInitialize = function () {
                ...
                if (this.lastWord) {
                    ...
                    this.options.match(t, function (t) {
                        if (t) {
                            var e = "";
                            if ("string" == typeof t ? e = Nt.createText(t) : t instanceof jQuery ? e = t[0] : t instanceof Node && (e = t), !e) return;
                            o.lastWord.insertNode(e), o.lastWord = null, o.context.invoke("editor.focus")
                        }
                    })
                }
            }, t.prototype.handleKeydown = function (t) {
                if (this.previousKeydownCode && z.contains(this.keys, this.previousKeydownCode)) this.previousKeydownCode = t.keyCode;
                else {
                    if (z.contains(this.keys, t.keyCode)) {
                        var e = this.context.invoke("editor.createRange").getWordRange();
                        this.lastWord = e
                    }
                ...
                z.contains(this.keys, t.keyCode) && this.replace()
            }, t
        }(),
        te = function () {
            function t(t) {
        ...
        ee = function () {
            ...
            return t.prototype.representShortcut = function (t) {
                ...
                return this.fontInstalledMap.hasOwnProperty(t) || (this.fontInstalledMap[t] = R.isFontInstalled(t) || z.contains(this.options.fontNamesIgnoreCheck, t)), this.fontInstalledMap[t]
            }, t.prototype.isFontDeservedToAdd = function (t) {
                return "" !== (t = t.toLowerCase()) && this.isFontInstalled(t) && -1 === C.inArray(t, ["sans-serif", "serif", "monospace", "cursive", "fantasy"])
                ...
                return this.ui.buttonGroup({
                    ...
                    children: [this.button({
                        ...
                        click: function (t) {
                            ...
                            } else if (z.contains(["backColor", "foreColor"], n)) {
                ...
                this.context.memo("button.bold", function () {
                    ...
                    return C.each(t["font-family"].split(","), function (t, e) {
                        e = e.trim().replace(/['"]+/g, ""), n.isFontDeservedToAdd(e) && -1 === C.inArray(e, n.options.fontNames) && n.options.fontNames.push(e)
                ...
                for (var o = 0, n = e.length; o < n; o++) {
                    for (var i = e[o], r = C.isArray(i) ? i[0] : i, s = C.isArray(i) ? 1 === i.length ? [i[0]] : i[1] : [i], a = this.ui.buttonGroup({
                            className: "note-" + r
                ...
                if (this.updateBtnStates(e, {
                    ...
                    var i = o["font-family"].split(",").map(function (t) {
                        ...
                        r = z.find(i, this.isFontInstalled.bind(this));
        ...
        ne = function () {
            ...
            return t.prototype.initialize = function () {
                ...
                t.on("keypress", function (t) {
                    t.keyCode === Ht.code.ENTER && (t.preventDefault(), e.trigger("click"))
                })
                ...
                return C.Deferred(function (n) {
                    ...
                    c.ui.onDialogShown(c.$dialog, function () {
                        c.context.triggerEvent("dialog.shown"), !l.url && A.isValidUrl(l.text) && (l.url = l.text), i.val(l.text);
                        var t = function () {
                        ...
                        r.on("input", e).on("paste", function () {
                            setTimeout(e, 0)
                        }).val(l.url), R.isSupportTouch || r.trigger("focus"), c.toggleLinkBtn(s, i, r), c.bindEnterKey(r, s), c.bindEnterKey(i, s);
        ...
        ie = function () {
            ...
            return t.prototype.shouldInitialize = function () {
                return !z.isEmpty(this.options.popover.link)
            }, t.prototype.initialize = function () {
                ...
                return C.Deferred(function (e) {
                    ...
                    i.ui.onDialogShown(i.$dialog, function () {
                        i.context.triggerEvent("dialog.shown"), t.replaceWith(t.clone().on("change", function (t) {
                            ...
                            var t = o.val();
                            i.ui.toggleBtn(n, t)
                        }).val(""), R.isSupportTouch || o.trigger("focus"), i.bindEnterKey(o, n)
        ...
        se = function () {
            ...
            return t.prototype.shouldInitialize = function () {
                return !z.isEmpty(this.options.popover.image)
            }, t.prototype.initialize = function () {
                this.$popover = this.ui.popover({
                ...
                if (Nt.isImg(t)) {
                    var o = Nt.posFromPlaceholder(t),
                        n = Nt.posFromPlaceholder(this.editable);
                    this.$popover.css({
                        display: "block",
        ...
        ae = function () {
            ...
            return t.prototype.shouldInitialize = function () {
                return !z.isEmpty(this.options.popover.table)
            }, t.prototype.initialize = function () {
                this.$popover = this.ui.popover({
        ...
        le = function () {
            ...
            return t.prototype.initialize = function () {
                ...
                if (o && 11 === o[1].length) {
                    ...
                    e = C("<iframe>").attr("frameborder", 0).attr("src", "//www.youtube.com/embed/" + f + (0 < m ? "?start=" + m : "")).attr("width", "100%").attr("height", "360")
            ...
            function t(t) {
                ...
                this.context = t, this.ui = C.summernote.ui, this.options = t.options, this.events = {
                    ...
                    "summernote.focusout": function (t, e) {
                        R.isFF || e.relatedTarget && Nt.ancestor(e.relatedTarget, A.eq(o.$popover[0])) || o.hide()
                    }
                }
            }
            return t.prototype.shouldInitialize = function () {
                return this.options.airMode && !z.isEmpty(this.options.popover.air)
            }, t.prototype.initialize = function () {
                this.$popover = this.ui.popover({
                ...
                if (t.range && !t.range.isCollapsed()) {
                    var e = z.last(t.range.getClientRects());
                    if (e) {
                        var o = A.rect2bnd(e);
                        this.$popover.css({
                            display: "block",
        ...
        ue = function () {
            function t(t) {
                var o = this;
                this.context = t, this.ui = C.summernote.ui, this.$editable = t.layoutInfo.editable, this.options = t.options, this.hint = this.options.hint || [], this.direction = this.options.hintDirection || "bottom", this.hints = C.isArray(this.hint) ? this.hint : [this.hint], this.events = {
                    "summernote.keyup": function (t, e) {
                        e.isDefaultPrevented() || o.handleKeyup(e)
                    },
                    "summernote.keydown": function (t, e) {
            ...
            return t.prototype.shouldInitialize = function () {
                ...
                this.$popover.is(":visible") && (t.keyCode === Ht.code.ENTER ? (t.preventDefault(), this.replace()) : t.keyCode === Ht.code.UP ? (t.preventDefault(), this.moveUp()) : t.keyCode === Ht.code.DOWN && (t.preventDefault(), this.moveDown()))
                ...
                var o = this;
                if (!z.contains([Ht.code.ENTER, Ht.code.UP, Ht.code.DOWN], t.keyCode)) {
                    var e = this.context.invoke("editor.getLastRange").getWordRange(),
                        n = e.toString();
                    if (this.hints.length && n) {
                        this.$content.empty();
                        var i = A.rect2bnd(z.last(e.getClientRects()));
    ...
    C.summernote = C.extend(C.summernote, {
        ...
        options: {
            ...
            spellCheck: !0,
            styleTags: ["p", "blockquote", "pre", "h1"],
            fontNames: ["Ubuntu", "Arial", "Arial Black", "Comic Sans MS", "Courier New", "Helvetica Neue", "Helvetica", "Impact", "Lucida Grande", "Tahoma", "Times New Roman", "Verdana"],
            ...
            codeviewIframeWhitelistSrcBase: ["www.youtube(?:-nocookie)?.com", "www.facebook.com", "vine.co", "instagram.com", "player.vimeo.com", "www.dailymotion.com", "player.youku.com", "v.qq.com"],
            keyMap: {
                pc: {
